...
a.href = "https://www.sololearn.com/Profile/19181657/?ref=app";
var b = " " + "   " + "  " + "    " +
    "💝  Follow me in Sololearn ‼️ \n" + "\n" +
    "   " + "     " + "  " + "   🌟🌟 Support Me 💯💝"
alert(b + " \n  " + "  " + " \n" + "     " + "       " + "❌Created BY Adnan❌" + "\n" + " \n" + "        " + "                  👇👇" + " \n" + " \n   " + a);
...
alert("Try Red Color! And Don't Forget To Comment Your Score! Enjoy the game!")
...
window.onload = function() {
    alert("Thank you all for Always supporting!")
